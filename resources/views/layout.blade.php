...
<head>
	...
	<title>Shop Nội Thất Furni-Orange</title>
	{{-- Seo --}}
			...
			<div class="container wide">
				...
				<div class="header-bottom-container">
					...
					<div class="logo-with-offcanvas d-flex">
						...
						<div class="logo">
							<a href="index.html">
								<img src="{{('public/frontend/images/logo_furni.png')}}" style="width:50%" class="img-fluid" alt="">
							</a>
						</div>
		...
		<div class="container wide">
			<div class="row">
				<div class="col footer-single-widget">
					...
					<div class="logo">
						<img src="{{('public/frontend/images/logo_furni.png')}}" class="img-fluid" alt="">
					</div>
